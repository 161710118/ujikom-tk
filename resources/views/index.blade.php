...
@section('content')
         <div id="layerslider">
            ...
            <div class="ls-slide" data-ls="transition2d:104;timeshift:-2000;">
               <!-- Background image -->
               <img src="{{asset('assets/user/img/slide1.jpg')}}" class="ls-bg"  alt="Slide background"/>
               <!-- Parallax Image -->
               <img src="{{asset('assets/user/img/sun.png')}}" class="ls-l img-responsive hidden-xs hidden-sm parallax1" alt="" data-ls="delayin:1000;easingin:fadeIn;parallaxlevel:7;">
               <!-- Text -->
               ...
               <!-- Parallax Image -->
               <img src="{{asset('assets/user/img/flower.png')}}" class="ls-l img-responsive hidden-xs hidden-sm parallax2" alt="" data-ls="delayin:1500;easingin:fadeIn;parallaxlevel:6;">
            </div>
            <!-- Slide 2 -->
            <div class="ls-slide" data-ls="transition2d:104;timeshift:-2000;">
               <!-- Background image -->
               <img src="{{asset('assets/user/img/slide2.jpg')}}" class="ls-bg"  alt="Slide background"/>
               <!-- Parallax Image -->
               <img src="{{asset('assets/user/img/bee.png')}}" class="ls-l img-responsive hidden-xs hidden-sm parallax1" alt="" data-ls="delayin:1500;easingin:fadeIn;parallaxlevel:7;">
               <!-- Text -->
               ...
               <!-- Parallax Image -->
               <img src="{{asset('assets/user/img/star.png')}}" class="ls-l img-responsive hidden-xs hidden-sm parallax2" alt="" data-ls="delayin:1500;easingin:fadeIn;parallaxlevel:6;">
            </div>
            <!-- Slide 3 -->
            <div class="ls-slide" data-ls="transition2d:104;timeshift:-2000;">
               <!-- Background image -->
               <img src="{{asset('assets/user/img/slide3.jpg')}}" class="ls-bg"  alt="Slide background"/>
               <!-- Parallax Image -->
               <img src="{{asset('assets/user/img/sun.png')}}" class="ls-l img-responsive hidden-xs hidden-sm parallax1" alt="" data-ls="delayin:1000;easingin:fadeIn;parallaxlevel:7;">
               <!-- Text -->
               <div class="ls-l header-text"  data-ls="offsetxin:0;durationin:2000;delayin:1500;easingin:easeOutElastic;rotatexin:-90;transformoriginin:50% top 0;offsetxout:-200;durationout:1000;parallaxlevel:2;">
            ...
            <div class="ls-slide" data-ls="transition2d:104;timeshift:-2000;">
               <!-- Background image -->
               <img src="{{asset('assets/user/img/slide4.jpg')}}" class="ls-bg"  alt="Slide background"/>
               <!-- Parallax Image -->
               <img src="{{asset('assets/user/img/bee.png')}}" class="ls-l img-responsive hidden-xs hidden-sm parallax1" alt="" data-ls="delayin:1500;easingin:fadeIn;parallaxlevel:7;">
               <!-- Text -->
               <div class="ls-l header-text" data-ls="offsetxin:0;durationin:2000;delayin:1500;easingin:easeOutElastic;rotatexin:-90;transformoriginin:50% top 0;offsetxout:-200;durationout:1000;parallaxlevel:2;">
            ...
            <div class="ls-slide" data-ls="transition2d:104;timeshift:-2000;">
               <!-- Background image -->
               <img src="{{asset('assets/user/img/slide5.jpg')}}" class="ls-bg"  alt="Slide background"/>
               <!-- Video -->
            ...
            <div class="container">
               ...
               <div class="row">
                  ...
                  <div class="col-md-12 col-lg-5">
                     <!-- Image -->
                     <img src="{{asset('assets/user/img/services.png')}}" alt="" class="img-responsive center-block">
                  </div>
                  <!-- /col-md-12-->
               </div>
               <!-- /row -->
               <div class="row">
                  ...
                  <div class="col-md-4 col-sm-12">
                     <div class="service float">
                        <img src="{{asset('/assets/images/avatar/'.$data->foto.'') }}" alt="" class="img-circle center-block img-responsive">
                        <h4>{{$data->nama}}</h4>
                        <p>{{$data->deskripsi}}</p>
                        <p>{{$data->tgl}}</p>
                     </div>
         ...
         <section id="about">
            <div class="container">
               ...
               <div class="row">
                  <div class="col-sm-12 col-lg-5">
                     ...
                     <div id="owl-about" class="owl-carousel">
                        <div class="item">
                           <img class="img-responsive" src="{{asset('assets/user/img/about1.jpg')}}" alt="">
                        </div>
                        <div class="item">
                           <img class="img-responsive" src="{{asset('assets/user/img/about2.jpg')}}" alt="">
                        </div>
                        <div class="item">
                           <img class="img-responsive" src="{{asset('assets/user/img/about3.jpg')}}" alt="">
                        </div>
                     </div>
                  </div>
                  <!-- text -->
               ...
               <div class="col-lg-12 col-sm-12 paper_block">
                  <h3 class="text-center">Testimoni Orang Tua</h3>
         ...
         <div class="parallax-object1 hidden-sm hidden-xs" data-0="opacity:1;"
            ...
            <!-- Image -->
            <img src="{{asset('assets/user/img/parallaxobject1.png')}}" alt="">
         </div>
         <!-- Section Team -->
            ...
            <div class="container">
               ...
               <div class="row team">
                  <div class="col-lg-5 col-md-5 res-margin">
                     <!-- Intro image -->
                     <img src="{{asset('assets/user/img/teammain.jpg')}}" class="center-block img-responsive img-curved" alt=""/>
                  </div>
                  <div class="col-lg-7 col-md-7">
                     <h3>Ai Badriah S.pd.I</h3>
                     <p>Ibu lum orci eget, viverra elit. Aliquam erat volut pat phas ellus ac
                        sodales felis tiam non Doloreiur qui commolu ptatemp dolupta orem retibusam 
                        andigen Ibu lum orci eget, viverra elit aliquam erat volut pat phas ellus ac sodales felis tiam non metus.
                  ...
                  <div class="col-lg-12">
                     ...
                     <div class="team-item">
                        ...
                        <div class="team-caption">
                           <h5 class="text-light">{{$data->nama}}</h5>
                           <p>{{$data->jabatan}}</p>
                        </div>
                     </div>
                     <!-- /team-item-->
                  ...
                  <div class="tab-content col-md-12 col-centered">
                     ...
                     <div class="tab-pane active in fade" id="tab1">
                        <div class="row">
                           <div class="col-md-5 col-lg-5 pull-left">
                              <!-- Activity image-->
                              <img src="{{asset('assets/user/img/activity1.jpg')}}" alt="" class="img-responsive img-circle">						
                           </div>
                     ...
                     <div class="tab-pane fade" id="tab2">
                        <div class="row">
                           <div class="col-md-5 col-lg-5 pull-left">
                              <!-- Activity image-->
                              <img src="{{asset('assets/user/img/activity2.jpg')}}" alt="" class="img-responsive img-circle">						
                           </div>
                           <div class="col-md-7 col-lg-7 pull-left">
                              <!-- Activity text-->
                     ...
                     <div class="tab-pane fade" id="tab3">
                        <div class="row">
                           <div class="col-md-5 col-lg-5 pull-left">
                              <!-- Activity image-->
                              <img src="{{asset('assets/user/img/activity3.jpg')}}" alt="" class="img-responsive img-circle">						
                           </div>
                           <div class="col-md-7 col-lg-7 pull-left">
                              <!-- Activity text-->
                              <h3>Lunch</h3>
                     ...
                     <div class="tab-pane fade" id="tab4">
                        <div class="row">
                           <div class="col-md-5 col-lg-5 pull-left">
                              <!-- Activity image-->
                              <img src="{{asset('assets/user/img/activity4.jpg')}}" alt="" class="img-responsive img-circle">						
                           </div>
                           <div class="col-md-7 col-lg-7 pull-left">
                              <!-- Activity text-->
                              <h3>Swimming</h3>
                     ...
                     <div class="tab-pane fade" id="tab5">
                        <div class="row">
                           <div class="col-md-5 col-lg-5 pull-left">
                              <!-- Activity image-->
                              <img src="{{asset('assets/user/img/activity5.jpg')}}" alt="" class="img-responsive img-circle">						
                           </div>
                           <div class="col-md-7 col-lg-7 pull-left">
                              <!-- Activity text-->
                              <h3>Playground</h3>
         ...
         <div class="parallax-object2 hidden-sm hidden-xs" data-0="opacity:1;"
            ...
            data-center-center="transform:translatey(-180%);">
            <!-- Image -->
            <img src="{{asset('assets/user/img/parallaxobject2.png')}}" alt="">
         </div>
         <!-- Section Gallery -->
            ...
            <div class="container">
               ...
               <div class="text-center col-md-12">
                  <ul class="nav nav-pills cat text-center" role="tablist" id="gallerytab">
                     ...
                     <li><a href="#" data-toggle="tab" data-filter=".web{{$data->id}}">{{$data->nama_kategori}}</a></li>
                     @endforeach
                  </ul>
               </div>
               ...
               @foreach($galeris as $data)
                        <div class="col-sm-6 col-md-6 col-lg-4 web{{$data->Kategorigaleri->id}}">
                           <div class="portfolio-item">
                              <div class="gallery-thumb">
                                 <img class="img-responsive" src="{{asset('/assets/images/avatar/'.$data->gambar.'') }}" alt="">
                                 <span class="overlay-mask"></span>
                                 <a href="{{asset('/assets/images/avatar/'.$data->gambar.'') }}" data-gal="prettyPhoto[gallery]" class="link centered" title="{{$data->nama}}">
               ...
               <div class="row color_block">
                  <div id="owl-blog" class="owl-carousel">
                     ...
                     <div class="blog-preview col-md-12">
                        <!-- Blog image -->
                        <img src="{{asset('assets/user/img/blogprev1.jpg')}}" alt="" />
                     ...
                     <div class="blog-preview col-md-12">
                        <!-- Blog image -->
                        <img src="{{asset('assets/user/img/blogprev2.jpg')}}" alt="" />
                        <div class="latest-caption text-center">
                           <a href="blog-post.html">
                     ...
                     <div class="blog-preview col-md-12">
                        <!-- Blog image -->
                        <img src="{{asset('assets/user/img/blogprev3.jpg')}}" alt="" />
                        <div class="latest-caption text-center">
                           <a href="blog-post.html">
                     ...
                     <div class="blog-preview col-md-12">
                        <!-- Blog image -->
                        <img src="{{asset('assets/user/img/blogprev4.jpg')}}" alt="" />
                        <div class="latest-caption text-center">
                           <a href="blog-post.html">
                              <h4>New Classroom</h4>
                           </a>
                     ...
                     <div class="blog-preview col-md-12">
                        <!-- Blog image -->
                        <img src="{{asset('assets/user/img/blogprev5.jpg')}}" alt="" />
                        <div class="latest-caption text-center">
                           <a href="blog-post.html">
                     ...
                     <div class="blog-preview col-md-12">
                        <!-- Blog image -->
                        <img src="{{asset('assets/user/img/blogprev6.jpg')}}" alt="" />
                        <div class="latest-caption text-center">
                           <a href="blog-post.html">
                              <h4>Toddler Care</h4>
                           </a>
         ...
         <div class="parallax-object3 hidden-sm hidden-xs" data-0="opacity:1;"
            ...
            <!-- Image -->
            <img src="{{asset('assets/user/img/parallaxobject3.png')}}" alt="">
         </div>
         <!-- Section Prices -->
