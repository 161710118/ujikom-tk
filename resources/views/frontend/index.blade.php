...
<link rel="stylesheet" href="{{asset('assets/css/flexslider.css')}}" type="text/css" media="all" property="" /> 
<!-- //Custom Theme files -->
<!-- font-awesome icons -->
      ...
      <nav class="navbar navbar-default">
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <h1><a href="index.html">TK</a></h1>
          </div> 
          <!-- Collect the nav links, forms, and other content for toggling -->
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-left"> 
              <li><a href="/" class="">Home</a></li>
              <li><a href="{{Route('profil.index')}}" class="">Profil</a></li>   
              <li><a href="{{Route('program.index')}}" class="">Program</a></li>
                  <li><a href="{{Route('fasilitas.index')}}" class="">Fasilitas</a></li>
                  <li><a href="{{Route('gurus')}}" class="">Guru</a></li>
                  <li><a href="portfolio.html" class="">Galeri</a></li>    
                </ul>
              </li>  
            </ul>    
          ...
          <ul class="slides">
            <li>
              ...
              <div class="w3-button">
                   <div class="w3ls-button">
                    <a href="#" class="hvr-shutter-out-vertical" data-toggle="modal" data-target="#myModal">Read More</a>
                </div>
                <div class="w3l-button">
                 <a href="portfolio.html" class="hvr-shutter-out-vertical">Portfolio</a>
                </div>
                <div class="clearfix"> </div>
            ...
            <li>
              <div class="banner-w3lstext">
                ...
                <div class="w3l-button">
                 <a href="portfolio.html" class="hvr-shutter-out-vertical scroll ">Portfolio</a>
                </div>
                <div class="clearfix"> </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header"> 
          ...
          <h4 class="modal-title">Taman <span>Kanak-kanak</span></h4>
        </div> 
        <div class="modal-body">
          <div class="agileits-w3layouts-info">
            <img src="{{asset('assets/images/modal1.jpg')}}" alt="" />
...
<!-- stats -->
  <div class="stats">
    <div class="container">
      ...
      <div class="col-md-3 w3_stats_left">
        <h3>Our Statistics</h3>
        <p>Nunc mauris nulla, suscipit sit amet ultricies eu, faucibus et orci. Morbi bibendum euismod lectus</p>
          ...
          <div class="wthree_testimonials_grid_main">
            <div class="wthree_testimonials_grid">
              ...
              <div class="wthree_testimonials_grid_pos">
                <img src="{{asset('assets/images/t11.jpg')}}" alt=" " class="img-responsive" />
              </div>
            </div>
          ...
          <div class="wthree_testimonials_grid_main">
            <div class="wthree_testimonials_grid">
              ...
              <p>Lorem laoreet eu purus eu viverra. Vestibulum sed convallis massa,
                ...
                <h5>Linda Carl</h5>
              <div class="wthree_testimonials_grid_pos">
                <img src="{{asset('assets/images/t22.jpg')}}" alt=" " class="img-responsive" />
              </div>
            </div>
          ...
          <div class="wthree_testimonials_grid_main">
            <div class="wthree_testimonials_grid">
              ...
              <p>Donec laoreet eu purus eu viverra. Vestibulum sed convallis massa,
                ...
                <h5>Michael Paul</h5>
              <div class="wthree_testimonials_grid_pos">
                <img src="{{asset('assets/images/t33.jpg')}}" alt=" " class="img-responsive" />
              </div>
            </div>
