        ...
        <div class="auto-container">
            ...
            <div class="mixitup-gallery">
                ...
                <div class="filter-list row clearfix">
                    ...
                    <div class="gallery-item mix all campus video col-md-4 col-sm-6 col-xs-12 web{{$data->Kategorifasilitas ->id}}">
                        <div class="inner-box">
                            <figure class="image-box">
                                ...
                                <div class="caption-box clearfix">
                                    ...
                                    <div class="icon-box">
                                        <a href="{{asset('/assets/images/avatar/'.$data->gambar.'') }}" class="link" data-fancybox="fasilitas" data-caption="{{$data->nama}}"><span class="icon fa fa-search"></span></a>
                                    </div>
                                </div>
                            </figure>
                        </div>
